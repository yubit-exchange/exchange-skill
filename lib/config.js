...
function loadConfig(overrides = {}) {
  ...
  return {
    ...
    baseUrl: (overrides.baseUrl || process.env.EXCHANGE_BASE_URL || fileConfig.baseUrl || DEFAULT_BASE_URL).replace(/\/$/, ''),
...
module.exports = { loadConfig, HOME_CONFIG, LOCAL_CONFIG, DEFAULT_BASE_URL };
